    ...
    def __init__(self,
        ...
        for i in range(num_stages):
            ...
            block = nn.ModuleList([Block(
                ...
                block_type='wave' if i < 3 else 'std_att')
...
@register_model
def wavemsa_s(pretrained=False, **kwargs):
    model = wavemsa(
        stem_hidden_dim=32,
        embed_dims=[64, 128, 320, 448],
        num_heads=[2, 4, 10, 14],
...
@register_model
def wavemsa_b(pretrained=False, **kwargs):
    model = wavemsa(
        stem_hidden_dim=64,
...
@register_model
def wavemsa_l(pretrained=False, **kwargs):
    model = wavemsa(
        stem_hidden_dim=64,
