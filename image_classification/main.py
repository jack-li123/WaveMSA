...
def get_args_parser():
    ...
    parser.add_argument('--config', default='/data/LXY/classification_wave/configs/wavemsa/wavemsa_s.py',required=False, type=str, help='config')
    parser.add_argument('--tensorboard', type=str, default='/data/LXY/classification_wave/logs/tensorboard')
    parser.add_argument('--logs', type=str, default='/data/LXY/classification_wave/logs')
    ...
    # Dataset parameters
    parser.add_argument('--data-path', default='/data/dataset_all/ImageNet2012', type=str,
                        help='dataset path')
...
def main(args):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        train_stats = train_one_epoch(
            ...
            fp32=args.fp32_resume, args=args,writer=writer
        )
